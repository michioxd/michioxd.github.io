import { IconButton, Link, Select, Text, ThemePanel, Tooltip } from '@radix-ui/themes';
...
export default function Footer() {
    const [openRadixThemePanel, setOpenRadixThemePanel] = useState(false);
    return (
        <>
            {openRadixThemePanel && <ThemePanel />}
                ...
                <div className={cls.Inner}>
                    ...
                    <div className="flex gap-1">
                        <Tooltip content="Change Theme">
                            <IconButton
                                color={openRadixThemePanel ? undefined : 'gray'}
                                variant="soft"
                                onClick={() => setOpenRadixThemePanel((p) => !p)}
                            >
                                <PiPaintBrushDuotone />
                            </IconButton>
                        </Tooltip>
