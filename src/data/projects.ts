...
const Projects = [
    {
        ...
        name: 'osu!space',
        type: 'osu! Rulesets',
        description: 'Custom game mode for osu!(lazer) based on Sound Space (Roblox) and Sound Space Plus game.',
        tech: ['C#'],
        buttons: [
            {
                name: 'GitHub',
                url: 'https://github.com/michioxd/osu-space',
            },
            {
                name: 'Demo Video',
    ...
    },
    {
        ...
        type: 'Extension',
        description:
            'A Visual Studio Code extension that helps you pick Material icons for your React MUI-based projects.',
        tech: ['TypeScript'],
        buttons: [
            {
                name: 'GitHub',
    ...
    },
    {
        ...
        type: 'Extension',
        description:
            'A better Dark theme for SoundCloud. Discontinued because SoundCloud has a built-in dark mode now.',
        tech: ['JavaScript', 'Chromium', 'Firefox'],
        buttons: [
            {
                name: 'GitHub',
